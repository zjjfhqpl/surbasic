...
void ecies_dec_without_user_privkey()
{
	...
	try { 
		...
		OCTETSTR K1; // 128 bit symmetric encryption key
		OCTETSTR K2; // 128 bit MAC key
...
void ecies_enc_dec_test()
{
	...
	//use_NIST_B_163();
	//EC_Domain_Parameters dp163 = NIST_B_163;
	//ECPubKey pk2(dp163, Point(fx, fy));
